...
urlpatterns = [
	...
	url(r'^password_reset/$', PasswordResetView.as_view(email_template_name='account/password_reset_email.html', subject_template_name='account/password_reset_subject.txt'), name='passwordReset'),
